...
export const metadata: Metadata = {
  title: "Validator",
  description: "Validate FHIR JSON and XML resources against base FHIR R4 rules and selected profiles.",
};
    ...
    <div className="py-16 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-lg text-slate-500 leading-relaxed mb-10">
          Validate FHIR JSON and XML resources against base FHIR R4 rules and selected profiles.
          Supports validation of Bundles, Patient Summary and ePrescription examples.
        </p>
