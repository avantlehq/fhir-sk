  ...
  return (
    <div className="py-16 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <h1 className="text-3xl font-bold text-slate-900 mb-4">Terminology</h1>
        <p className="text-lg text-slate-500 mb-10">
          FHIR uses structured vocabularies. Learn to work with CodeSystem, ValueSet, ConceptMap and key terminologies.
        </p>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 text-center">
          <p className="text-blue-700 font-semibold mb-1">Content coming in Phase 4</p>
